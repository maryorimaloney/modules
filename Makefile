...
# files targeted
all: test2 test1try q_test1 q_test2 q_test3 q_test4 q_test5 q_test6 q_test7 q_test8 q_test9 q_test10 q_test11
...
# cleaning all
clean:
	rm -f *.o test1try test2 q_test1 q_test2 q_test3 q_test4 q_test5 q_test6 q_test7 q_test8 q_test9 q_test10 q_test11
